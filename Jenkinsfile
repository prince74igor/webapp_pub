  ...
  stages {
    ...
    stage ('Source Composition Analysis') {
      steps {
         ...
         sh 'gem list -i "^bundler-audit$" || sudo gem install --http-proxy http://proxy.compassplus.ru:3128 bundler-audit && bundle-audit update --http-proxy http://proxy.compassplus.ru:3128'
